...
export function QRCodeGrid({ activeTab, viewMode }: QRCodeGridProps) {
  const filteredData = qrCodeData.filter(qr => {
    if (activeTab === 'all') return true;
    if (activeTab === 'dynamic') return qr.type === 'dynamic';
    if (activeTab === 'static') return qr.type === 'static';
    if (activeTab === 'active') return qr.status === 'active';
    if (activeTab === 'inactive') return qr.status === 'inactive';
    return true;
  });
