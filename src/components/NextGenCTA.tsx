...
const NextGenCTA = () => {
  ...
  const benefits = [
    { icon: Rocket, text: "Launch in 60 seconds" },
  ...
  const stats = [
    ...
    { number: "15M+", label: "QR Codes Created" },
        ...
        <div className="text-center space-y-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="relative group p-6 rounded-2xl backdrop-blur-xl border border-white/20 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-110"
                style={{
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm px-6 py-4 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 group"
              >
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8 justify-center items-center">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 hover:from-cyan-600 hover:via-blue-700 hover:to-purple-700 text-white px-16 py-8 text-2xl font-black shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 hover:scale-110 group border-0 relative overflow-hidden rounded-3xl" 
                asChild
              >
                <Link to="/register">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-cyan-400/50 hover:border-cyan-400 bg-cyan-400/10 hover:bg-cyan-400/20 text-cyan-400 hover:text-white px-16 py-8 text-2xl font-black backdrop-blur-xl rounded-3xl transition-all duration-300 hover:scale-110 group shadow-xl"
                onClick={() => {
            ...
            <div className="flex flex-wrap justify-center gap-6 text-white">
              {[
                ...
                <span 
                  key={index} 
                  className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 font-semibold hover:bg-white/20 transition-all duration-300 hover:scale-105"
                >
                  {indicator}
                </span>
              ))}
          ...
          <div className="relative h-32">
            {[Rocket, Shield, Globe, Zap].map((Icon, index) => (
              <div
                key={index}
                className="absolute w-16 h-16 bg-gradient-to-r from-cyan-400/20 to-purple-400/20 backdrop-blur-xl rounded-2xl flex items-center justify-center border border-white/20"
                style={{
                  top: '50%',
                  left: '50%',
