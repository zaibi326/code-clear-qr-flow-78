  ...
  return (
    <div className="h-full w-full flex items-center justify-center p-4 bg-gray-100">
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4 relative">
        {/* Error message - always render if there's an error */}
        {backgroundError && (
        ...
        {/* Loading overlay - only when not loaded and no error */}
        ...
        {/* Canvas - always render to maintain stable DOM structure */}
        <canvas
          ref={canvasRef}
          ...
          style={{ 
            width: '600px',
            height: '450px',
            opacity: backgroundLoaded || backgroundError ? 1 : 0.3
          }}
        />
      </div>
    </div>
