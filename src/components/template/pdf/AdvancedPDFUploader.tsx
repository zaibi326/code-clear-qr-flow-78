...
interface AdvancedPDFUploaderProps {
...
export const AdvancedPDFUploader: React.FC<AdvancedPDFUploaderProps> = ({
  onUploadComplete,
  onCancel,
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
        <div className="p-4">
          ...
          <h4 className="font-medium text-gray-900 mb-1">PDF Support</h4>
          <p className="text-sm text-gray-600">
            Full support for all PDF formats and features
          </p>
        </div>
        <div className="p-4">
          <Upload className="w-8 h-8 text-blue-600 mx-auto mb-2" />
          <h4 className="font-medium text-gray-900 mb-1">Large Files</h4>
          <p className="text-sm text-gray-600">
            Upload PDFs up to {Math.round(maxFileSize / (1024 * 1024))}MB in size
          </p>
        </div>
        <div className="p-4">
          <CheckCircle className="w-8 h-8 text-blue-600 mx-auto mb-2" />
          <h4 className="font-medium text-gray-900 mb-1">Fast Processing</h4>
          <p className="text-sm text-gray-600">
            Quick upload and processing for immediate editing
          </p>
        </div>
      </div>
    </div>
